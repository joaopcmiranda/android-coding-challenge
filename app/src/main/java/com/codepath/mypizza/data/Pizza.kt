...
object Pizza {
    ...
    var pizzaMenu = arrayOf("ALL MEAT PIZZA", "CALIFORNIA VEGGIE", "GARLIC CHICKEN", "PANACEA MEAT", "CURRY DELIGHT", "NEW WORLD", "OLD SCHOOL", "ALL MEAT PIZZA", "CALIFORNIA VEGGIE", "GARLIC CHICKEN", "PANACEA MEAT", "CURRY DELIGHT", "NEW WORLD", "OLD SCHOOL", "RACLETE OVERLOAD")

    var pizzaDetails = arrayOf("Premium Crushed Tomato Sauce made of 100% California grown vine ripened tomatoes topped with premium salami, pepperoni, all-natural Italian sausage and seasoned pork.",
