...
object Pizza {
    ...
    var pizzaMenu = arrayOf("ALL MEAT PIZZA", "CALIFORNIA VEGGIE", "GARLIC CHICKEN", "PANACEA MEAT", "CURRY DELIGHT", "NEW WORLD", "OLD SCHOOL", "ALL MEAT", "CALIFORNIA", "GARLIC", "MEAT", "PORK DELIGHT", "NEW HORIZON", "OLD CHAP", "RACLETE MIGHT")

    var pizzaDetails = arrayOf("Premium Crushed Tomato Sauce made of 100% California grown vine ripened tomatoes topped with premium salami, pep peroni, all-natural Italian sausage and seasoned pork.",
